...
export function buildTemplate(p: string, opts: TemplateOptions): string {
  ...
  if (opts.showMethod) {
    h += '<section class="fc-block fc-method">'
      ...
      + 'the fitted elasticity is about 0.35, meaning a company ten times larger draws a fine only about twice as '
      ...
      + 'than a fallback. Inside the EUR 1bn to 100bn band the five well evidenced violation categories have median '
      + 'indices between 0.0020% and 0.0023% of turnover, which is no difference worth having. Size is what moves the '
      + 'number, by a factor of several hundred across the range, and size is the one thing you always know.</p>'
      ...
      + 'and the range is the 25th to the 90th percentile. Across the whole dataset the 25th percentile is about '
      + '0.0009% of turnover and the 90th about 0.98%, a spread of three orders of magnitude for the same statute.</p>'
