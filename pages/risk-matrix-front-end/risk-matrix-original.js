...
const RISK_CATALOG = {
  Privacy: [
    ...
    { group: "02.05 Consent", label: "Silence treated as consent", text: "Pre-ticked boxes, inactivity, continued browsing or prior agreement are treated as consent", mitigation: "Require a clear affirmative action, remove pre-ticked boxes, and treat ambiguity as no consent.", likelihood: "Likely", impact: "High" },
    { group: "02.05 Consent", label: "Purposes bundled together", text: "Several unrelated purposes are combined into a single all-or-nothing consent request", mitigation: "Present each purpose separately so people can accept some and refuse others, and never make consent for one purpose a condition of an unrelated service.", likelihood: "Likely", impact: "Medium" },
    ...
    { group: "04.03 Records & Retention", label: "Information stored outside approved systems", text: "Business information is kept on local drives, removable media or personal applications rather than approved systems", mitigation: "Direct working material into approved systems by default, prohibit local and removable storage for business data, and make the approved route the easier one.", likelihood: "Likely", impact: "High" },
    { group: "04.03 Records & Retention", label: "No retention label applied", text: "Content is never labelled, so it is either deleted automatically while still needed or kept indefinitely", mitigation: "Apply retention labels at creation, use the default schedule where none is chosen, and make clear which content will be removed automatically if unlabelled.", likelihood: "Likely", impact: "High" },
    { group: "04.03 Records & Retention", label: "Oversharing through broad permissions", text: "Sites, folders and files are shared with broad groups or open links rather than named recipients", mitigation: "Default sharing to specific people, make sites private by default, remove organisation-wide access where it is not needed, and review permissions on a regular cycle.", likelihood: "Likely", impact: "High" },
    { group: "04.03 Records & Retention", label: "Hidden content shared inside files", text: "A file is shared carrying hidden rows, filtered data, pivot caches, comments, tracked changes or earlier versions", mitigation: "Inspect documents before sharing, remove hidden and residual content, and share aggregated or masked extracts rather than full working files.", likelihood: "Likely", impact: "High" },
    { group: "04.03 Records & Retention", label: "Recipients not validated", text: "Information goes to the wrong person because autocomplete or an outdated distribution list was trusted", mitigation: "Check recipients deliberately rather than relying on autocomplete, confirm distribution list ownership and membership, and verify business need before sending.", likelihood: "Likely", impact: "Medium" },
    { group: "04.03 Records & Retention", label: "Duplicate copies proliferate", text: "Multiple copies of the same information exist with no single source of truth, so retention and accuracy break down", mitigation: "Keep one authoritative copy and share links rather than attachments, delete temporary copies once finished, and avoid exporting full datasets.", likelihood: "Likely", impact: "Medium" },
    { group: "04.03 Records & Retention", label: "Access never reviewed", text: "Site and folder permissions are never revisited, so leavers and former project members retain access", mitigation: "Review owners, members, guests and sharing links on a defined cycle, remove leavers promptly, and document the outcome of each review.", likelihood: "Likely", impact: "High" },
    { group: "04.03 Records & Retention", label: "Content deleted under hold", text: "Records are deleted during routine clean-up while subject to a legal, tax, audit or investigation hold", mitigation: "Check for an applicable hold before any deletion or archive clean-up, and apply holds formally so routine deletion is suspended automatically.", likelihood: "Unlikely", impact: "High" },
    { group: "05.01 Customer Communications", label: "Promotional content in a service message", text: "A single promotional line, link or offer is added to an operational message, converting it into marketing", mitigation: "Keep service and promotional content strictly separate, review templates for promotional wording, and remember that one promotional phrase changes the message's legal character.", likelihood: "Likely", impact: "High" },
    { group: "05.01 Customer Communications", label: "Marketing-sourced contacts used for service", text: "Contact details gathered from a competition, marketing list or lead form are used for operational messages", mitigation: "Use contact details only in the context they were collected, and check the collection source before adding anyone to an operational send.", likelihood: "Possible", impact: "High" },
    { group: "05.01 Customer Communications", label: "Message sent by a different entity", text: "A message is sent by a different legal entity from the one that collected the contact details", mitigation: "Confirm the sending entity matches the one that collected the data, or provide clear notice and a lawful basis before a different entity makes contact.", likelihood: "Possible", impact: "Medium" },
    { group: "05.01 Customer Communications", label: "Contact preferences ignored", text: "A customer has objected to a type of contact but still receives it", mitigation: "Record objections centrally, apply them across every sending system, and honour objections to non-essential contact even where the message is operational.", likelihood: "Possible", impact: "High" },
    { group: "05.01 Customer Communications", label: "Notice or preference link missing", text: "Messages go out without a privacy notice link or a way for the customer to manage contact settings", mitigation: "Include a privacy notice link and, where available, a preference centre link as standard elements of every customer message template.", likelihood: "Likely", impact: "Medium" },
    { group: "05.01 Customer Communications", label: "Platform used before approval", text: "An SMS gateway, automation tool, service platform or chatbot is used before vendor, contract and security review", mitigation: "Complete vendor, contract, technology and privacy review before any platform handles customer communications, including chatbots and ticketing tools.", likelihood: "Possible", impact: "High" },
    { group: "05.02 Marketing", label: "Marketing without valid opt-in", text: "Marketing is sent without a recorded, channel-specific opt-in from the recipient", mitigation: "Confirm a valid opt-in exists for the specific channel before any send, keep consent records with timestamp, wording and source, and do not launch if it is missing.", likelihood: "Possible", impact: "High" },
    { group: "05.02 Marketing", label: "No working unsubscribe", text: "A campaign goes out without a functioning, free unsubscribe mechanism", mitigation: "Test the unsubscribe path on every campaign before sending, and treat a broken unsubscribe as a blocker rather than a defect to fix later.", likelihood: "Possible", impact: "High" },
    { group: "05.02 Marketing", label: "Marketing misclassified", text: "A promotional message is classified and sent as a transactional or service communication", mitigation: "Classify by content rather than by system tag, and treat any promotional element as making the whole message marketing.", likelihood: "Possible", impact: "High" },
    { group: "05.02 Marketing", label: "Opt-outs processed slowly", text: "Unsubscribe requests are not actioned promptly, so recipients keep receiving messages", mitigation: "Process opt-outs into the suppression list within the shortest applicable deadline, and confirm suppression has reached every sending system and vendor.", likelihood: "Possible", impact: "High" },
    { group: "05.02 Marketing", label: "Profiling without transparency", text: "Segmentation, behavioural analytics or lookalike audiences are used without the notice covering it", mitigation: "Ensure the privacy notice describes the profiling actually performed, apply data minimisation, and avoid inferences based on sensitive characteristics.", likelihood: "Likely", impact: "Medium" },
    { group: "05.02 Marketing", label: "Children targeted or profiled", text: "Campaigns target, profile or track children without enhanced controls and review", mitigation: "Involve privacy and legal before any campaign that could reach minors, and do not profile or track children's behaviour without a clear lawful basis.", likelihood: "Unlikely", impact: "Critical" },
    { group: "05.02 Marketing", label: "Broker data used without diligence", text: "Data obtained from a broker is used for marketing without validating source, transparency and consent", mitigation: "Validate that broker data was lawfully collected and that individuals were informed, confirm consent and opt-out positions, and put contractual controls in place before use.", likelihood: "Possible", impact: "High" }
  ],
  AI: [
